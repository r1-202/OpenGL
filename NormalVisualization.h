...
int scene7()
{
    ...
    // -------------------------
    Shader ourShader("vertexshader2.vs", "fragmentshader2.fs");
    Shader normalShader("shader7.vs", "shader7.fs", "shader7.gs");

    // load models
    // -----------
    const char* p = "textures/backpack/backpack.obj";
    Model ourModel(p);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setVec3("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5f)); // darken diffuse light a bit
